...
define('BASE_URL', 'http://localhost/dhvanyaloka-mvc/');
...
define('DB_PREFIX', 'dhv');
define('DB_HOST', 'localhost');
define('DB_NAME', 'dhvanyaloka');
define('dhvanyaloka_USER', 'root');
define('dhvanyaloka_PASSWORD', 'mysql');
?>
